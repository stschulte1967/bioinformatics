...
fn test_linear_score(input_file: &str) {
    let input_params = read_parameters_from_file("../../data/4K/inputs/".to_string() + input_file);
    let output_params = read_parameters_from_file("../../data/4K/outputs/".to_string() + input_file);
